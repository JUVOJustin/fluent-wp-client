...
export const searchField = {
  search: z.string().optional()
    .describe('Limit results to those matching a string. Searches title and content by default.'),
};
...
function sortFields<T extends readonly [string, ...string[]]>(options: T) {
  return {
    ...
    orderby: z.enum(options).optional()
...
export const postsCollectionInputSchema = z.object({
  ...searchField,
  searchColumns: z.array(z.enum(['post_title', 'post_content', 'post_excerpt'])).optional()
    .describe('Which columns to search when search is set. Defaults to title + content. Requires WordPress 6.1+.'),
  ...paginationFields,
  ...sortFields(['date', 'id', 'title', 'slug', 'modified', 'relevance', 'author', 'include']),
  ...fieldSelectionFields,
  include: z.array(z.number().int()).optional()
    .describe('Fetch specific posts by ID. Use perPage: 100 to retrieve all in one request.'),
  ...
  status: z.enum(['publish', 'draft', 'pending', 'private', 'future', 'trash']).optional()
...
export const pagesCollectionInputSchema = z.object({
  ...searchField,
  ...paginationFields,
  ...sortFields(['date', 'id', 'title', 'slug', 'modified', 'relevance', 'author', 'include', 'menu_order']),
  ...fieldSelectionFields,
  include: z.array(z.number().int()).optional()
  ...
  parent: z.number().int().optional()
    .describe('Filter by parent page ID'),
  author: z.number().int().optional()
    .describe('Filter by author ID'),
}).describe(
...
export const mediaCollectionInputSchema = z.object({
  ...searchField,
  ...paginationFields,
  ...sortFields(['date', 'id', 'title', 'slug', 'modified', 'relevance', 'author', 'include']),
  ...fieldSelectionFields,
  ...
  mediaType: z.enum(['image', 'video', 'audio', 'application']).optional()
...
export const categoriesCollectionInputSchema = z.object({
  ...searchField,
  ...paginationFields,
  ...
  hideEmpty: z.boolean().optional()
    .describe('Hide categories with no posts'),
  parent: z.number().int().optional()
...
export type CategoriesCollectionInput = z.infer<typeof categoriesCollectionInputSchema>;

// ---------------------------------------------------------------------------
// Tag collection input
// ---------------------------------------------------------------------------

export const tagsCollectionInputSchema = z.object({
  ...searchField,
  ...paginationFields,
  ...sortFields(['id', 'name', 'slug', 'count', 'term_group', 'include']),
  ...fieldSelectionFields,
  ...
  hideEmpty: z.boolean().optional()
    .describe('Hide tags with no posts'),
}).describe(
...
export const usersCollectionInputSchema = z.object({
  ...searchField,
  ...paginationFields,
  ...sortFields(['id', 'name', 'slug', 'email', 'url', 'registered_date', 'include']),
  ...fieldSelectionFields,
  include: z.array(z.number().int()).optional()
...
export const commentsCollectionInputSchema = z.object({
  ...searchField,
  ...paginationFields,
  ...sortFields(['date', 'date_gmt', 'id', 'include', 'post', 'parent', 'type']),
  ...fieldSelectionFields,
...
export type CommentsCollectionInput = z.infer<typeof commentsCollectionInputSchema>;
...
export type ContentCollectionInput = z.infer<typeof contentCollectionInputSchema>;

// ---------------------------------------------------------------------------
// Generic term collection input (for custom taxonomies)
// ---------------------------------------------------------------------------

export const termCollectionInputSchema = z.object({
  ...searchField,
  ...paginationFields,
  ...fieldSelectionFields,
  order: z.enum(['asc', 'desc']).optional()
  ...
  orderby: z.string().optional()
    .describe('Field to sort by'),
  hideEmpty: z.boolean().optional()
    .describe('Hide terms with no posts'),
...
export const contentGetInputSchema = z.object({
  ...
  slug: z.string().optional()
    .describe('Resource slug (provide id or slug)'),
  ...fieldSelectionFields,
 ...
 */
export const simpleGetInputSchema = z.object({
  id: z.number().int().optional()
    .describe('Resource ID (provide id or slug)'),
  slug: z.string().optional()
    .describe('Resource slug (provide id or slug)'),
...
export const postCreateInputSchema = z.object({
  input: z.object({
    ...
    featured_media: z.number().int().optional().describe('Featured image ID'),
    categories: z.array(z.number().int()).optional().describe('Category IDs'),
    tags: z.array(z.number().int()).optional().describe('Tag IDs'),
    meta: z.record(z.string(), z.unknown()).optional().describe('Custom meta fields'),
  }).passthrough().describe('Post fields to set'),
...
export const postUpdateInputSchema = z.object({
  ...
  input: z.object({
    ...
    tags: z.array(z.number().int()).optional().describe('Tag IDs'),
    meta: z.record(z.string(), z.unknown()).optional().describe('Custom meta fields'),
  }).passthrough().describe('Post fields to update'),
...
export const termUpdateInputSchema = z.object({
  ...
  input: z.object({
    ...
    parent: z.number().int().optional().describe('Parent term ID'),
    meta: z.record(z.string(), z.unknown()).optional().describe('Custom meta fields'),
  }).passthrough().describe('Term fields to update'),
...
export const userCreateInputSchema = z.object({
  ...
  }).passthrough().describe('User fields to set'),
...
export const userUpdateInputSchema = z.object({
  ...
  input: z.object({
    ...
    roles: z.array(z.string()).optional().describe('User roles'),
  }).passthrough().describe('User fields to update'),
...
export const commentCreateInputSchema = z.object({
  ...
  }).passthrough().describe('Comment fields to set'),
...
export const commentUpdateInputSchema = z.object({
  ...
  input: z.object({
    ...
    status: z.string().optional().describe('Comment status'),
  }).passthrough().describe('Comment fields to update'),
...
export const contentCreateInputSchema = z.object({
  input: z.record(z.string(), z.unknown())
    .describe('Resource fields to set'),
...
export const contentUpdateInputSchema = z.object({
...
export const settingsUpdateInputSchema = z.object({
  input: z.object({
    ...
    start_of_week: z.number().int().optional().describe('Start of week (0=Sunday)'),
    posts_per_page: z.number().int().optional().describe('Posts per page'),
  }).passthrough().describe('Settings fields to update'),
...
export const abilityRunInputSchema = z.object({
  name: z.string().describe('Ability name in namespace/ability format'),
  input: z.unknown().optional()
...
export const abilityDeleteInputSchema = z.object({
  name: z.string().describe('Ability name in namespace/ability format'),
  input: z.unknown().optional()

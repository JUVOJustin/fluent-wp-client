...
describe('Zod helpers: runtime catalog-to-Zod conversion', () => {
  ...
  describe('zodSchemasFromDescription() — resources', () => {
    it('converts all operation schemas for a content resource', () => {
      const schemas = zodSchemasFromDescription(catalog.content.posts) as ResourceZodSchemas;
    ...
    it('converts all operation schemas for a custom post type', () => {
      const schemas = zodSchemasFromDescription(catalog.content.books) as ResourceZodSchemas;
    ...
    it('converts all operation schemas for a term resource', () => {
      const schemas = zodSchemasFromDescription(catalog.terms.categories) as ResourceZodSchemas;
    ...
    it('converts all schemas for a first-class resource', () => {
      const schemas = zodSchemasFromDescription(catalog.resources.media) as ResourceZodSchemas;
  ...
  describe('zodSchemasFromDescription() — abilities', () => {
    it('converts input and output schemas for an ability', () => {
      ...
      const schemas = zodSchemasFromDescription(abilityDesc) as AbilityZodSchemas;
    ...
    it('input schema validates correct ability input', () => {
      const schemas = zodSchemasFromDescription(catalog.abilities['test/process-complex']) as AbilityZodSchemas;
